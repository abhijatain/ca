<template>
    <div class="border-b p-3  flex flex-col items-center justify-between md:flex-row gap-3  ">
        ...
        <div class="md:flex flex-row gap-3 hidden " >
            ...
            <div class="">
                <div class="flex flex-row my-auto">
                        <p class="text-center text-xs mb-2"><span class="font-bold">abhijatain</span> | May 12, 2024</p>
                ...
                <NuxtLink to="/discussions/post" >
                <h5 class=" font-bold mb-2 hover:text-[#023c6c] dark:hover:text-blue-400 ">
                    Best way to have GIF favicon but icon in all browsers?Best way to have GIF favicon but icon in all browsers?
                </h5>
            </NuxtLink>
            </div>
